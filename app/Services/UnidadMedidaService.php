...
{
    private $modulo = "UNIDADES DE MEDIDA";
    ...
    public function actualizar(array $datos, UnidadMedida $unidad_medida): UnidadMedida
    {
        ...
        // registrar accion
        $this->historialAccionService->registrarAccion($this->modulo, "MODIFICACIÓN", "ACTUALIZÓ UNA UNIDAD DE MEDIDA", $old_unidad_medida, $unidad_medida->withoutRelations());
    ...
    {
        $old_unidad_medida = clone $unidad_medida;
        $usos = Producto::where("unidad_medida_id", $unidad_medida->id)->count();
        if ($usos > 0) {
        ...
        // registrar accion
        $this->historialAccionService->registrarAccion($this->modulo, "ELIMINACIÓN", "ELIMINÓ UNA UNIDAD DE MEDIDA", $old_unidad_medida, $unidad_medida);
