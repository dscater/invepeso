...
class MarcaService
{
    ...
    public function actualizar(array $datos, Marca $marca): Marca
    {
        ...
        // registrar accion
        $this->historialAccionService->registrarAccion($this->modulo, "MODIFICACIÓN", "ACTUALIZÓ UNA MARCA", $old_marca, $marca->withoutRelations());
    ...
    {
        $old_marca = clone $marca;
        $usos = Producto::where("marca_id", $marca->id)->count();
        if ($usos > 0) {
        ...
        // registrar accion
        $this->historialAccionService->registrarAccion($this->modulo, "ELIMINACIÓN", "ELIMINÓ UNA MARCA", $old_marca, $marca);
