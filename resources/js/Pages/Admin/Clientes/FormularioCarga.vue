...
const tituloDialog = computed(() => {
    return `<i class="fa fa-upload"></i> Carga Masiva de Clientes`;
});
...
const enviarFormulario = () => {
    enviando.value = true;
    let url = route("clientes.cargaClientes");
    form.post(url, {
        preserveScroll: true,
        forceFormData: true,
        onSuccess: (response) => {
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-success text-center">
                            <a :href="route('clientes.formato')" target="_blank"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-warning pb-0">
                            <ul class="pb-0">
                                <li>
                                    Para llenar TIPO DOCUMENTO con un carnet use
                                    <b>CI</b>, y llenar el COMPLEMENTO si
                                    corresponde.
                                </li>
                            </ul>
                        </div>
