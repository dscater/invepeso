...
const { setUnidadMedida, limpiarUnidadMedida, form } = useUnidadMedidas();
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            let respuesta = await axiosDelete(
                route("unidad_medidas.destroy", item.id),
            );
    ...
    <Content>
        <template #header>
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="m-0">
                        <i class="fa fa-list"></i> Unidades de Medidas
                    </h3>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-12">
                        <MiTable
                            ...
                            :cols="headers"
                            :api="true"
                            :url="route('unidad_medidas.paginado')"
                            :numPages="5"
