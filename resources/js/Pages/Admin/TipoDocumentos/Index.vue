...
const { setTipoDocumento, limpiarTipoDocumento, form } = useTipoDocumentos();
...
const eliminarTipoDocumento = (item) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            let respuesta = await axiosDelete(
                route("tipo_documentos.destroy", item.id),
            );
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        >
                            <i class="fa fa-plus"></i> Nueva Tipo de Documento
                        </button>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <MiTable
                            ...
                            :cols="headers"
                            :api="true"
                            :url="route('tipo_documentos.paginado')"
                            :numPages="5"
                                ...
                                >
                                    ...
                                    >
                                        <button
                                            ...
                                            @click="eliminarTipoDocumento(item)"
                                        >
                                            <i
