...
const { setProveedor, limpiarProveedor, form } = useProveedors();
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            let respuesta = await axiosDelete(
                route("proveedors.destroy", item.id),
            );
...
<template>
    ...
    <Content>
        <template #header>
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="m-0"><i class="fa fa-truck"></i> Proveedores</h3>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
