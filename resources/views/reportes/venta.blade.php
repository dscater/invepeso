...
<body>
    ...
    <div class="encabezado">
        ...
        <h4 class="texto">COMPROBANTE DE VENTA</h4>
    ...
    <table class="info">
        <tbody>
            ...
            <tr>
                <td><span class="bold">Tipo de Venta:</span> {{ $venta->tipo_venta }}</td>
                <td><span class="bold">Tipo de Pago:</span> {{ $venta->tipo_pago }}</td>
            </tr>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="bold derecha">{{ $venta->subtotal }}</td>
            </tr>
            <tr>
                <td class="bold derecha" colspan="5">DESCUENTO BS.</td>
                <td class="bold derecha">{{ $venta->descuento }}</td>
            </tr>
            <tr>
                <td class="bold derecha" colspan="5">TOTAL FINAL BS.</td>
                <td class="bold derecha">{{ $venta->total }}</td>
            </tr>
            @if ($venta->tipo_venta == 'CRÉDITO')
                <tr>
                    <td class="bold derecha" colspan="5">CANCELADO BS.</td>
                    <td class="bold derecha">{{ $venta->cancelado }}</td>
                </tr>
                <tr>
                    <td class="bold derecha" colspan="5">SALDO BS.</td>
                    <td class="bold derecha">{{ $venta->saldo }}</td>
                </tr>
            @endif
        </tbody>
    </table>
